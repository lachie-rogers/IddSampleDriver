...
NTSTATUS IddSampleMonitorQueryModes(IDDCX_MONITOR MonitorObject, const IDARG_IN_QUERYTARGETMODES* pInArgs, IDARG_OUT_QUERYTARGETMODES* pOutArgs)
{
    ...
    vector<IDDCX_TARGET_MODE> TargetModes(35);
    ...
    CreateTargetMode(TargetModes[7], 3440, 1440, 60);
    CreateTargetMode(TargetModes[8], 3200, 2400, 60);
    CreateTargetMode(TargetModes[9], 3200, 1800, 60);
    CreateTargetMode(TargetModes[10], 3008, 1692, 60);
    CreateTargetMode(TargetModes[11], 2880, 1800, 60);
    CreateTargetMode(TargetModes[12], 2880, 1620, 60);
    CreateTargetMode(TargetModes[13], 2560, 1600, 60);
    CreateTargetMode(TargetModes[14], 2560, 1440, 60);
    CreateTargetMode(TargetModes[15], 1920, 1440, 60);
    CreateTargetMode(TargetModes[16], 1920, 1200, 60);

    CreateTargetMode(TargetModes[17], 1920, 1080, 60);
    CreateTargetMode(TargetModes[18], 1600, 1024, 60);
    CreateTargetMode(TargetModes[19], 1680, 1050, 60);
    CreateTargetMode(TargetModes[20], 1600, 900, 60);
    CreateTargetMode(TargetModes[21], 1440, 900, 60);
    CreateTargetMode(TargetModes[22], 1400, 1050, 60);
    CreateTargetMode(TargetModes[23], 1366, 768, 60);
    CreateTargetMode(TargetModes[24], 1360, 768, 60);
    CreateTargetMode(TargetModes[25], 1280, 1024, 60);
    CreateTargetMode(TargetModes[26], 1280, 960, 60);
    CreateTargetMode(TargetModes[27], 1280, 800, 60);
    CreateTargetMode(TargetModes[28], 1280, 768, 60);
    CreateTargetMode(TargetModes[29], 1280, 720, 60);
    CreateTargetMode(TargetModes[30], 1280, 600, 60);
